export class GameScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(
            ...
            'assets/player_name_placeholder.png'
        );
    ...
    loadAllCards() {
        ...
        console.log(
            `Loaded ${suits.length * values.length + variantCards.length} card images`
        );
    }
    ...
    createProgressBar() {
        ...
        this.progressBarInner = this.add.rectangle(
            barX,
            barY,
            barWidth,
            barHeight,
    ...
    createCardContainer() {
        ...
        this.secondCard = this.add.image(
            startX + cardSpacing,
            40,
            'queen_of_clubs2'
        );
        ...
        this.thirdCard = this.add.image(
            startX + cardSpacing * 2,
            40,
            '3_of_clubs'
        );
        this.thirdCard.setScale(cardScale);

        this.fourthCard = this.add.image(
            startX + cardSpacing * 3,
            40,
            '3_of_clubs'
        );
        this.fourthCard.setScale(cardScale);

        this.fifthCard = this.add.image(
            startX + cardSpacing * 4,
            40,
            '3_of_clubs'
        );
        ...
        console.log(
            'Card container created with 5 cards centered on gaming table'
        );
    }

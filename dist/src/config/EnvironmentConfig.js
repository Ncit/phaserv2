...
class EnvironmentConfig {
    ...
    initializeGlobalConfig() {
        ...
        window.gameConfig = {
            ...
            isMobileDebuggingEnabled: () => this.isMobileDebuggingEnabled(),
            onEnvironmentChange: null, // Callback for environment changes
        };
    ...
    /**
     * Check if mobile debugging (Eruda) is enabled
     */
    isMobileDebuggingEnabled() {
        return this.isFeatureEnabled('mobileDebugging');
    }
    ...
    triggerEnvironmentChange() {
        if (window.gameConfig && window.gameConfig.onEnvironmentChange) {
...
// Export mobile debugging method
export const isMobileDebuggingEnabled = () => environmentConfig.isMobileDebuggingEnabled();

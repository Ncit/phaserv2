export class LoadingScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('top_bar', window.isWinline ? 'assets/top_bar_logo.png' : 'assets/top_bar_logo_betboom.png');
        ...
        this.load.image('chip_button', window.isWinline ? 'assets/chip_button.png' : 'assets/chip_button_betboom.png');
        ...
        this.load.image('ai_bot_btn', window.isWinline ? 'assets/train_game.png' : 'assets/train_game_betboom.png');

        // Load bonus button asset
        this.load.image('bonus_button', window.isWinline ? 'assets/bonus_button.png' : 'assets/bonus_button_betboom.png');
